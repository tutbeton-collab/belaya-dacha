...
def fix_paths_in_file(filepath):
    ...
    content = re.sub(r'href="/_next/static/', f'href="{BASE_PATH}/assets/static/', content)
    
    # Исправляем пути к JS в HTML
    content = re.sub(r'src="/_next/static/', f'src="{BASE_PATH}/assets/static/', content)
    ...
    # "static/chunks/ -> "/belaya-dacha/assets/static/chunks/
    content = re.sub(r'"static/chunks/', f'"{BASE_PATH}/assets/static/chunks/', content)
    
    # Исправляем пути к CSS в JSON (href:"/_next/static/css/ -> href:"/belaya-dacha/assets/static/css/)
    content = re.sub(r'href:"/_next/static/css/', f'href:"{BASE_PATH}/assets/static/css/', content)
    
    # Исправляем пути к JS в JSON
    content = re.sub(r'"/_next/static/', f'"{BASE_PATH}/assets/static/', content)
